...
public:
	...
	/*
 	Este é o operador de acesso ao elemento do array. Ele retorna uma referência ao elemento no índice especificado, permitindo a leitura ou modificação do 
  	valor desse elemento.
   	*/
	const T& operator[](unsigned int index) const;
	/*
 	Este é o operador de acesso ao elemento do array constante. Ele permite a leitura do elemento no índice especificado, mas não permite a modificação 
  	do valor desse elemento.
   	*/
